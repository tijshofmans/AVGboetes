...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($overtreder)) {
        ...
        try {
            ...
            $slug_check = $pdo->prepare("SELECT COUNT(*) FROM avg_boetes WHERE slug = ?");
            ...
            // Insert nieuwe boete
            $stmt = $pdo->prepare("
                INSERT INTO avg_boetes 
                (overtreder, boetebedrag, datum, avg_artikel, introtekst, volledige_tekst, externe_link, status, slug) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
...
<head>
    ...
    <title>Nieuwe Boete Toevoegen - AVG Boetes CMS</title>
        ...
        <div class="form-container">
            <form method="POST" action="">
                ...
                <div class="form-actions">
                    <button type="submit" class="button">Boete opslaan</button>
